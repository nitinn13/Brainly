...
import { Brain, Globe, Lock, ArrowRight, Menu, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 text-gray-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-indigo-600">BrainWave</span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              {/* <button className="px-4 py-2 rounded-md text-sm font-medium text-indigo-600 border border-indigo-600 hover:bg-indigo-50">
                Log In
              </button> */}
              <NavLink to="/login" className="px-4 py-2 rounded-md text-sm font-medium text-indigo-600 border border-indigo-600 hover:bg-indigo-50">
                Log In
                </NavLink>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white pt-2 pb-3 space-y-1">
            ...
            <div className="pt-4 pb-3 border-t border-gray-200">
              <button className="block w-full text-left px-4 py-2 text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-md">
                Sign Up
              </button>
              
                <Link to="/login" className="mt-2 block w-full text-left px-4 py-2 text-base font-medium text-indigo-600 border border-indigo-600 hover:bg-indigo-50 rounded-md">
                  Log In
                </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              <h1>
                <span className="block text-base font-semibold tracking-wide text-indigo-600 uppercase">Introducing</span>
                <span className="mt-1 block text-4xl tracking-tight font-extrabold sm:text-5xl xl:text-6xl">
                  Your <span className="text-indigo-600">Second Brain</span> With Social Powers
                </span>
              </h1>
              ...
              <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                <div className="sm:flex">
                  <button className="w-full sm:w-auto flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 shadow-sm">
                    Get Started
            ...
            <div className="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
              <div className="relative mx-auto w-full rounded-lg shadow-lg lg:max-w-md">
                <div className="relative block w-full bg-white rounded-lg overflow-hidden border-4 border-indigo-100">
                  <img 
                    className="w-full" 
                  ...
                  <div className="absolute inset-0 w-full h-full flex items-center justify-center">
                    <div className="bg-white bg-opacity-75 px-4 py-2 rounded-md">
                      ...
                      <span className="text-indigo-600 font-medium">Watch Demo</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div id="how-it-works" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 lg:mt-20 lg:grid lg:grid-cols-3 lg:gap-8">
            {/* Step 1 */}
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-white">BrainWave</span>
            </div>
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            <div className="mt-8 md:mt-0 md:order-1">
              <p className="text-center text-base text-gray-400">
                &copy; 2025 BrainWave, Inc. All rights reserved.
              </p>
            </div>
          </div>
        </div>
